...
public class JettyFactory {
	...
	public static void setTldJarNames(Server server, String... jarNames) {
		...
		List<String> jarNameExprssions = Lists.newArrayList(".*/jstl-[^/]*${symbol_escape}${symbol_escape}.jar${symbol_dollar}", ".*/.*taglibs[^/]*${symbol_escape}${symbol_escape}.jar${symbol_dollar}");
		for (String jarName : jarNames) {
			jarNameExprssions.add(".*/" + jarName + "-[^/]*${symbol_escape}${symbol_escape}.jar${symbol_dollar}");
		}
